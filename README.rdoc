...
Cookbook takes you from a fresh Debian/Ubuntu server to a complete Nginx/Rails/PHP stack using purely Capistrano. It also takes care of app deployment and pretty much writes your <tt>deploy.rb</tt> file for you.
...
(Goto <b>Set up a PHP app</b> if deploying a PHP project)
...
Copy <tt><b>config/cookbook/deploy.rb.example</b></tt> to <tt><b>config/deploy.rb</b></tt>
  
Edit <tt>deploy.rb</tt> to your liking. Run <tt>cap -T</tt> to check out your new tasks.
