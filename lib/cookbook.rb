...
Dir["#{File.dirname(__FILE__)}/cookbook/*.rb"].each { |f| require f }
...
Capistrano::Configuration.instance(:must_exist).load do
  ...
  # Merge cookbook hash with capistrano
  ...
  set :sources,   fetch(:sources,   {
    ...
    :rubygems      => "http://rubyforge.org/frs/download.php/38646/rubygems-#{versions_rubygems}.tgz",
